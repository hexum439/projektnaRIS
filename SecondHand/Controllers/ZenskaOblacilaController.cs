...
namespace SecondHand.Controllers
{
	public class ZenskaOblacilaController : Controller
	{
		...
		public ZenskaOblacilaController(AppDbContext context, UserManager<ApplicationUser> usermanager)
		{
			_context = context;
		...
		public IActionResult Index()
		{
			...
			var data = _context.KategorijeOblacilas.Where(p => p.Spol.Equals('Ž')).ToList();
			return View(data);
		}
